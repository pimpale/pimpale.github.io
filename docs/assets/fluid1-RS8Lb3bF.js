import"./modulepreload-polyfill-9p4a8sJU.js";import{a as n,j as e}from"./bootstrap-E42M73Qn.js";import{A as y}from"./ArticleLayout-KUtTKUik.js";import{S as h}from"./Section-_7EI6j-o.js";import{H as c}from"./HrefLink-fS4a1NZj.js";import{A as p}from"./index-VWvRFLOi.js";import{f as A}from"./load-PyS1TEab.js";import{i as d}from"./react-katex.m-woX0cBsF.js";import{A as a}from"./AsideCard-7FxGktrb.js";import{d as g,e as u,g as f,o as T,c as E,h as L}from"./webgl-pz7ftDpC.js";import{c as b}from"./math--bhbm4JA.js";import{V as G}from"./visibility-iaPEh0e0.js";import{C as R}from"./canvas-qe4zxOb4.js";import{A as W}from"./arrow-90deg-down-RsGVyw6C.js";import{a as S,b as D}from"./Articles-M0Ek_QTT.js";import{c as U}from"./client-857oZWT1.js";import{S as k,a as C}from"./a11y-dark-jqEfC50T.js";import"./Layout-qOTRLYLo.js";import"./parse-XT2uv3NL.js";const F=`#version 300 es
in vec2 a_position;
out vec2 v_texCoord;
void main() {
...
`;class N extends n.Component{constructor(i){super(i),this.canvas=n.createRef(),this.animationLoop=()=>{this.requestID=window.requestAnimationFrame(this.animationLoop),this.gl.useProgram(this.program),this.gl.bindVertexArray(this.vao),this.gl.drawArrays(this.gl.TRIANGLES,0,6)}}componentDidMount(){this.gl=this.canvas.current.getContext("webgl2"),this.program=g(this.gl,[u(this.gl,this.gl.VERTEX_SHADER,F),u(this.gl,this.gl.FRAGMENT_SHADER,P)]);const i=this.gl.createBuffer();this.gl.bindBuffer(this.gl.ARRAY_BUFFER,i),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array([0,0,1,0,0,1,0,1,1,0,1,1]),this.gl.STATIC_DRAW);const s=this.gl.getAttribLocation(this.program,"a_position");this.vao=this.gl.createVertexArray(),this.gl.bindVertexArray(this.vao),this.gl.enableVertexAttribArray(s),this.gl.vertexAttribPointer(s,2,this.gl.FLOAT,!1,0,0),this.animationLoop()}componentWillUnmount(){window.cancelAnimationFrame(this.requestID)}render(){return e.jsx("canvas",{style:this.props.style,className:this.props.className,ref:this.canvas,height:this.props.size,width:this.props.size})}}const w=`#version 300 es
in vec2 c_position;
out vec2 v_texCoord;
