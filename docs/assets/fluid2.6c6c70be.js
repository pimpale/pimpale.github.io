import{S as m}from"./style.89069af4.js";import{f as d,a as h,j as s,b as i,R,F as E}from"./vendor.7cdf459d.js";import{A}from"./ArticleLayout.43969869.js";import{c as f,A as y}from"./math.642ab5a2.js";import{b as x,f as F,u as C,d as _,g as L,c,a as o,h as w}from"./webgl.eb3a0ae9.js";import{c as D}from"./noise.da95bb06.js";import{a as T}from"./assert.194f7a38.js";import{T as G}from"./camera.629194ae.js";function U(v,l){T(v>0),T(l>0);let e=[];for(let t=0;t<v;t++){const r=t/v,a=(t+1)/v;for(let n=0;n<l;n++){const g=n/l,u=(n+1)/l;e.push(d(r,g)),e.push(d(a,g)),e.push(d(r,u)),e.push(d(a,g)),e.push(d(a,u)),e.push(d(r,u))}}return e}const p=`#version 300 es
in vec2 c_position;
out vec2 v_texCoord;
