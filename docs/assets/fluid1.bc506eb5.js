import"./style.7f2dd081.js";import{a as h,j as s,b as a,R as x,F as T}from"./vendor.a4df3017.js";import{A as R}from"./ArticleLayout.cd7af887.js";import{S as m}from"./Section.f71e4728.js";import{c as f,A as v}from"./math.ad7d4be2.js";function l(e,i,t){const r=e.createShader(i);return e.shaderSource(r,t),e.compileShader(r),r}function p(e,i){const t=e.createProgram();for(const o of i)e.attachShader(t,o);if(e.linkProgram(t),e.getProgramParameter(t,e.LINK_STATUS))return t;for(const o of i)e.getShaderParameter(o,e.COMPILE_STATUS)||console.log(e.getShaderInfoLog(o)),e.deleteShader(o);return console.log(e.getProgramInfoLog(t)),e.deleteProgram(t),null}function E(e,i,t){const r=new Uint32Array(i*t),o=e.createTexture();return e.bindTexture(e.TEXTURE_2D,o),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.pixelStorei(e.UNPACK_ALIGNMENT,1),e.texImage2D(e.TEXTURE_2D,0,e.R32UI,i,t,0,e.RED_INTEGER,e.UNSIGNED_INT,r),o}function g(e,i,t,r,o,n){e.texSubImage2D(e.TEXTURE_2D,0,i,t,r,o,e.RED_INTEGER,e.UNSIGNED_INT,n)}const A=`#version 300 es
in vec4 position;
void main() {
