import"./modulepreload-polyfill.c7c6310f.js";import{a as l,j as t,b as i,R as y,F as A}from"./bootstrap.7d10a938.js";import{A as F}from"./ArticleLayout.ecb53228.js";import{S as g}from"./Section.8e815bfd.js";import{A as C}from"./AsideCard.1b9c35e1.js";import{o as f,a as w,u as L,c as m,b as S,d as n,e as a,f as D}from"./webgl.f33c1914.js";import{c as d}from"./math.e4175633.js";import{c as I}from"./noise.ab64560a.js";import{g as T}from"./uvplane.24bf49d0.js";import{T as G}from"./camera.1550a2e1.js";import{C as U}from"./canvas.b4c9bbaa.js";import"./mod.a5ac064f.js";const p=`#version 300 es
in vec2 c_position;
out vec2 v_texCoord;
...
`,H=20,j=20,b=T(H,j);class W extends l.Component{constructor(h){super(h),this.canvas=l.createRef(),this.range=l.createRef(),this.scalarSelect=l.createRef(),this.viewSelect=l.createRef(),this.velocitySelect=l.createRef(),this.scalarTextures=[],this.scalarFramebuffers=[],this.velTextures=[],this.velFramebuffers=[],this.pressureTextures=[],this.pressureFramebuffers=[],this.scalarIndex=0,this.velIndex=0,this.pressureIndex=0,this.needsScalarReset=!0,this.needsVelocityReset=!0,this.spherenessRange=l.createRef(),this.thetaRange=l.createRef(),this.phiRange=l.createRef(),this.lerpRange=l.createRef(),this.sphereCanvas=l.createRef(),this.handleSphereChange=()=>{const e=this.spherenessRange.current.valueAsNumber;this.thetaRange.current.valueAsNumber=e,this.phiRange.current.valueAsNumber=e,this.lerpRange.current.valueAsNumber=Math.min(e*1.5,1),this.handleCircularityChange()},this.handleCircularityChange=()=>{const e=this.thetaRange.current.valueAsNumber,s=this.phiRange.current.valueAsNumber,r=this.lerpRange.current.valueAsNumber;this.sphereGl.uniform1f(this.sphereThetaAlpha,e),this.sphereGl.uniform1f(this.spherePhiAlpha,s),this.sphereGl.uniform1f(this.sphereLerpAlpha,r)},this.animationLoop=()=>{var s,r,c;this.requestID=window.requestAnimationFrame(this.animationLoop),this.camera.update();const e=this.cmt.mousePos;if(e&&(this.gl.useProgram(this.prog_paint_vel),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.velFramebuffers[(this.velIndex+1)%2]),this.gl.uniform2f(this.oldMouseLoc,d(e.previous.x,0,this.props.xsize),d(this.props.ysize-e.previous.y,0,this.props.ysize)),this.gl.uniform2f(this.newMouseLoc,d(e.current.x,0,this.props.xsize),d(this.props.ysize-e.current.y,0,this.props.ysize)),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.velIndex=(this.velIndex+1)%2),this.needsScalarReset){const o=this.props.ysize;this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.scalarTextures[this.scalarIndex]);const u=parseInt((s=this.scalarSelect.current)==null?void 0:s.value),x=new Float32Array(this.props.xsize*this.props.ysize);for(let _=0;_<this.props.ysize;_++){const E=Math.floor(_/(o/u))%2;for(let v=0;v<this.props.xsize;v++)Math.floor(v/(o/u))%2+E==1?x[_*this.props.xsize+v]=1:x[_*this.props.xsize+v]=0}f(this.gl,0,0,this.props.xsize,this.props.ysize,x),this.needsScalarReset=!1}if(this.needsVelocityReset){this.gl.activeTexture(this.gl.TEXTURE3),this.gl.bindTexture(this.gl.TEXTURE_2D,this.pressureTextures[this.pressureIndex]),f(this.gl,0,0,this.props.xsize,this.props.ysize,new Float32Array(this.props.xsize*this.props.ysize)),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]);let o;switch((r=this.velocitySelect.current)==null?void 0:r.value){case"curlnoise":o=I(3,this.props.xsize,this.props.ysize,Math.random()*500);break;default:o=new Float32Array(this.props.xsize*this.props.ysize*2);break}w(this.gl,0,0,this.props.xsize,this.props.ysize,o),this.needsVelocityReset=!1}for(let o=0;o<this.range.current.valueAsNumber;o++){this.gl.useProgram(this.prog_advect_scalar),this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.scalarTextures[this.scalarIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.scalarFramebuffers[(this.scalarIndex+1)%2]),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.scalarIndex=(this.scalarIndex+1)%2,this.gl.useProgram(this.prog_advect_vel),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.velFramebuffers[(this.velIndex+1)%2]),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.velIndex=(this.velIndex+1)%2,this.gl.useProgram(this.prog_divergence),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.divFramebuffer),this.gl.drawArrays(this.gl.TRIANGLES,0,6);{this.gl.useProgram(this.prog_solve_pressure);for(let u=0;u<15;u++)this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,this.divTexture),this.gl.activeTexture(this.gl.TEXTURE3),this.gl.bindTexture(this.gl.TEXTURE_2D,this.pressureTextures[this.pressureIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.pressureFramebuffers[(this.pressureIndex+1)%2]),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.pressureIndex=(this.pressureIndex+1)%2}this.gl.useProgram(this.prog_apply_pressure_force),this.gl.activeTexture(this.gl.TEXTURE3),this.gl.bindTexture(this.gl.TEXTURE_2D,this.pressureTextures[this.pressureIndex]),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.velFramebuffers[(this.velIndex+1)%2]),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.velIndex=(this.velIndex+1)%2}{switch(this.gl.useProgram(this.prog_render),this.gl.activeTexture(this.gl.TEXTURE0),(c=this.viewSelect.current)==null?void 0:c.value){case"PRESSURE":{this.gl.bindTexture(this.gl.TEXTURE_2D,this.pressureTextures[this.pressureIndex]),this.gl.uniform1f(this.renderMultiplier,1),this.gl.uniform1f(this.renderOffset,.5);break}case"DIVERGENCE":{this.gl.bindTexture(this.gl.TEXTURE_2D,this.divTexture),this.gl.uniform1f(this.renderMultiplier,100),this.gl.uniform1f(this.renderOffset,.5);break}case"SCALAR":default:{this.gl.bindTexture(this.gl.TEXTURE_2D,this.scalarTextures[this.scalarIndex]),this.gl.uniform1f(this.renderMultiplier,1),this.gl.uniform1f(this.renderOffset,0);break}}this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,null),this.gl.drawArrays(this.gl.TRIANGLES,0,6)}{const o=this.camera.getTrackballCameraMatrix(this.props.spheresize,this.props.spheresize);this.sphereGl.uniformMatrix4fv(this.sphereWorldViewProjectionLoc,!1,o),L(this.sphereGl,this.sphereTexture,this.canvas.current),this.sphereGl.activeTexture(this.sphereGl.TEXTURE0),this.sphereGl.bindTexture(this.sphereGl.TEXTURE_2D,this.sphereTexture),this.sphereGl.enable(this.sphereGl.BLEND),this.sphereGl.blendFunc(this.sphereGl.SRC_ALPHA,this.sphereGl.ONE_MINUS_SRC_ALPHA),this.sphereGl.drawArrays(this.sphereGl.TRIANGLES,0,b.length)}}}componentDidMount(){this.gl=this.canvas.current.getContext("webgl2"),this.gl.getExtension("EXT_color_buffer_float");const h=this.gl.createBuffer();this.gl.bindBuffer(this.gl.ARRAY_BUFFER,h),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array(T(1,1).flatMap(e=>[e[0],e[1]])),this.gl.STATIC_DRAW);for(let e=0;e<2;e++){const s=m(this.gl,this.props.xsize,this.props.ysize,new Float32Array(this.props.xsize*this.props.ysize));this.scalarTextures.push(s);const r=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,r),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,s,0),this.scalarFramebuffers.push(r)}for(let e=0;e<2;e++){const s=S(this.gl,this.props.xsize,this.props.ysize,new Float32Array(this.props.xsize*this.props.ysize*2));this.velTextures.push(s);const r=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,r),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,s,0),this.velFramebuffers.push(r)}this.divTexture=m(this.gl,this.props.xsize,this.props.ysize,new Float32Array(this.props.xsize*this.props.ysize)),this.divFramebuffer=this.gl.createFramebuffer(),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.divFramebuffer),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,this.divTexture,0);for(let e=0;e<2;e++){const s=m(this.gl,this.props.xsize,this.props.ysize,new Float32Array(this.props.xsize*this.props.ysize));this.pressureTextures.push(s);const r=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,r),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,s,0),this.pressureFramebuffers.push(r)}{this.prog_advect_scalar=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,N)]);const e=this.gl.getAttribLocation(this.prog_advect_scalar,"c_position"),s=this.gl.getUniformLocation(this.prog_advect_scalar,"u_scalar_tex"),r=this.gl.getUniformLocation(this.prog_advect_scalar,"u_vel_tex");this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_advect_scalar),this.gl.uniform1i(s,0),this.gl.uniform1i(r,1)}{this.prog_advect_vel=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,z)]);const e=this.gl.getAttribLocation(this.prog_advect_vel,"c_position"),s=this.gl.getUniformLocation(this.prog_advect_vel,"u_vel_tex");this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_advect_vel),this.gl.uniform1i(s,1)}{this.prog_divergence=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,P)]);const e=this.gl.getAttribLocation(this.prog_divergence,"c_position"),s=this.gl.getUniformLocation(this.prog_divergence,"u_vel_tex");this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_divergence),this.gl.uniform1i(s,1)}{this.prog_solve_pressure=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,M)]);const e=this.gl.getAttribLocation(this.prog_solve_pressure,"c_position"),s=this.gl.getUniformLocation(this.prog_solve_pressure,"u_divergence_tex"),r=this.gl.getUniformLocation(this.prog_solve_pressure,"u_pressure_tex");this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_solve_pressure),this.gl.uniform1i(s,2),this.gl.uniform1i(r,3)}{this.prog_apply_pressure_force=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,V)]);const e=this.gl.getAttribLocation(this.prog_apply_pressure_force,"c_position"),s=this.gl.getUniformLocation(this.prog_apply_pressure_force,"u_vel_tex"),r=this.gl.getUniformLocation(this.prog_apply_pressure_force,"u_pressure_tex");this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_apply_pressure_force),this.gl.uniform1i(s,1),this.gl.uniform1i(r,3)}{this.prog_render=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,X)]);const e=this.gl.getAttribLocation(this.prog_render,"c_position"),s=this.gl.getUniformLocation(this.prog_render,"u_scalar_tex"),r=this.gl.getUniformLocation(this.prog_render,"u_vel_tex");this.renderMultiplier=this.gl.getUniformLocation(this.prog_render,"u_multiplier"),this.renderOffset=this.gl.getUniformLocation(this.prog_render,"u_offset"),this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_render),this.gl.uniform1i(s,0),this.gl.uniform1i(r,1)}{this.prog_paint_vel=n(this.gl,[a(this.gl,this.gl.VERTEX_SHADER,p),a(this.gl,this.gl.FRAGMENT_SHADER,O)]);const e=this.gl.getAttribLocation(this.prog_paint_vel,"c_position"),s=this.gl.getUniformLocation(this.prog_paint_vel,"u_vel_tex");this.newMouseLoc=this.gl.getUniformLocation(this.prog_paint_vel,"u_new_mouse"),this.oldMouseLoc=this.gl.getUniformLocation(this.prog_paint_vel,"u_old_mouse"),this.gl.enableVertexAttribArray(e),this.gl.vertexAttribPointer(e,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_paint_vel),this.gl.uniform1i(s,1)}{this.camera=new G(this.sphereCanvas.current,{}),this.sphereGl=this.sphereCanvas.current.getContext("webgl2",{premultipliedAlpha:!1}),this.sphereGl.enable(this.sphereGl.DEPTH_TEST),this.sphereTexture=D(this.sphereGl,this.props.spheresize,this.props.spheresize);const e=n(this.sphereGl,[a(this.sphereGl,this.sphereGl.VERTEX_SHADER,B),a(this.sphereGl,this.sphereGl.FRAGMENT_SHADER,k)]),s=this.sphereGl.getAttribLocation(e,"a_position"),r=this.sphereGl.getUniformLocation(e,"u_render_tex");this.sphereThetaAlpha=this.sphereGl.getUniformLocation(e,"u_thetaAlpha"),this.spherePhiAlpha=this.sphereGl.getUniformLocation(e,"u_phiAlpha"),this.sphereLerpAlpha=this.sphereGl.getUniformLocation(e,"u_lerpAlpha"),this.sphereWorldViewProjectionLoc=this.sphereGl.getUniformLocation(e,"u_worldViewProjection");const c=this.sphereGl.createBuffer();this.sphereGl.bindBuffer(this.sphereGl.ARRAY_BUFFER,c),this.sphereGl.bufferData(this.sphereGl.ARRAY_BUFFER,new Float32Array(b.flatMap(o=>[o[0],o[1]])),this.sphereGl.STATIC_DRAW),this.sphereGl.enableVertexAttribArray(s),this.sphereGl.vertexAttribPointer(s,2,this.sphereGl.FLOAT,!1,0,0),this.sphereGl.useProgram(e),this.sphereGl.uniform1f(this.sphereThetaAlpha,0),this.sphereGl.uniform1f(this.spherePhiAlpha,0),this.sphereGl.uniform1f(this.sphereLerpAlpha,0),this.sphereGl.uniform1i(r,0)}this.spherenessRange.current.addEventListener("input",this.handleSphereChange),this.thetaRange.current.addEventListener("input",this.handleCircularityChange),this.phiRange.current.addEventListener("input",this.handleCircularityChange),this.lerpRange.current.addEventListener("input",this.handleCircularityChange),this.cmt=new U(this.canvas.current),this.animationLoop()}getMousePos(h,e){const s=h.getBoundingClientRect(),r=h.width/s.width,c=h.height/s.height;return{x:(e.clientX-s.left)*r,y:(e.clientY-s.top)*c}}componentWillUnmount(){this.cmt.cleanup(),this.spherenessRange.current.removeEventListener("input",this.handleSphereChange),this.thetaRange.current.removeEventListener("input",this.handleCircularityChange),this.phiRange.current.removeEventListener("input",this.handleCircularityChange),this.lerpRange.current.removeEventListener("input",this.handleCircularityChange),window.cancelAnimationFrame(this.requestID),this.camera.cleanup()}render(){return t("div",{style:this.props.style,className:this.props.className,children:i("div",{className:"row",children:[t("div",{className:"col-md-8 d-flex",children:i("div",{children:[t("canvas",{className:"border border-dark mx-3 my-3",ref:this.canvas,width:this.props.xsize,height:this.props.ysize}),t("canvas",{className:"border border-dark mx-3 my-3",ref:this.sphereCanvas,width:this.props.spheresize,height:this.props.spheresize})]})}),i("div",{className:"col-md-4",children:[i("div",{className:"border border-dark p-3 m-3",children:[i("div",{className:"form-group mb-3",children:[t("label",{className:"form-label",children:"Simulation Speed"}),t("input",{type:"range",className:"form-range",min:"0",max:"5",step:1,defaultValue:1,ref:this.range})]}),i("div",{className:"form-group mb-3",children:[t("label",{className:"form-label",children:"Scalar Field"}),i("select",{className:"form-select mb-3",defaultValue:8,ref:this.scalarSelect,children:[t("option",{value:1,children:"Empty"}),t("option",{value:2,children:"Grid 2"}),t("option",{value:8,children:"Grid 8"}),t("option",{value:64,children:"Grid 64"})]}),t("button",{className:"btn btn-primary btn-sm",onClick:()=>this.needsScalarReset=!0,children:"Reset Scalar"})]}),i("div",{className:"form-group mb-3",children:[t("label",{className:"form-label",children:"Velocity Field"}),i("select",{className:"form-select mb-3",defaultValue:8,ref:this.velocitySelect,children:[t("option",{value:"empty",children:"Empty"}),t("option",{value:"curlnoise",children:"Curl Noise"})]}),t("button",{className:"btn btn-primary btn-sm",onClick:()=>this.needsVelocityReset=!0,children:"Reset Velocity"})]}),i("div",{className:"form-group mb-3",children:[t("label",{className:"form-label",children:"View Field"}),i("select",{className:"form-select",defaultValue:"SCALAR",ref:this.viewSelect,children:[t("option",{value:"SCALAR",children:"Scalar"}),t("option",{value:"PRESSURE",children:"Pressure"}),t("option",{value:"DIVERGENCE",children:"Divergence"})]})]})]}),i("div",{className:"border border-dark p-3 m-3",children:[i("div",{className:"form-group mb-3",children:[t("label",{className:"form-label",children:"Sphereness"}),t("input",{type:"range",className:"form-range",min:"0",max:"1",step:"0.05",defaultValue:"0",ref:this.spherenessRange})]}),t("div",{className:"form-group mb-3",children:i("details",{children:[t("summary",{children:"Advanced Sphere Controls"}),i("div",{className:"mx-auto d-block flex-grow-1 ",children:[t("label",{className:"form-label",children:"Join Major"}),t("input",{type:"range",className:"form-range",min:"0",max:"1",step:"0.05",defaultValue:"0",ref:this.thetaRange})]}),i("div",{className:"mx-auto d-block flex-grow-1 ",children:[t("label",{className:"form-label",children:"Join Minor"}),t("input",{type:"range",className:"form-range",min:"0",max:"1",step:"0.05",defaultValue:"0",ref:this.phiRange})]}),i("div",{className:"mx-auto d-block flex-grow-1 ",children:[t("label",{className:"form-label",children:"Alpha"}),t("input",{type:"range",className:"form-range",min:"0",max:"1",step:"0.05",defaultValue:"0",ref:this.lerpRange})]})]})})]})]})]})})}}const Y=()=>t(F,{children:({Citation:R,CitationBank:h})=>i(A,{children:[i(g,{id:"overview",name:"Overview",children:[t("p",{children:"Our goals are to:"}),i("ul",{children:[t("li",{children:"Map the fluid simulation onto a sphere."}),t("li",{children:"Make the fluid simulation 3D."})]})]}),i(g,{id:"Fluid3-unmapped-sphere",name:"Incompressible Fluid on a Sphere",children:[t("p",{children:"Incompressible"}),t(C,{title:"Canvas Setup",id:"canvas-setup-demo",children:t(W,{className:"mx-auto",style:{maxWidth:"40em"},xsize:400,ysize:400,spheresize:400})})]}),t(g,{id:"sources",name:"Sources",children:t(h,{})})]})});y.render(t(l.StrictMode,{children:t(Y,{})}),document.getElementById("root"));
