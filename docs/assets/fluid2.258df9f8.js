import{S as m}from"./style.23d33e06.js";import{f as d,a as h,j as s,b as i,R,F as E}from"./vendor.8c8c5e31.js";import{A}from"./ArticleLayout.576cc918.js";import{c as f,A as y}from"./math.d1c16880.js";import{b as x,f as F,u as C,d as _,g as L,c,a as o,h as w}from"./webgl.eb3a0ae9.js";import{c as D}from"./noise.d9f37728.js";import{a as T}from"./assert.194f7a38.js";import{T as G}from"./camera.f3a6df7d.js";function U(v,l){T(v>0),T(l>0);let e=[];for(let t=0;t<v;t++){const r=t/v,a=(t+1)/v;for(let n=0;n<l;n++){const g=n/l,u=(n+1)/l;e.push(d(r,g)),e.push(d(a,g)),e.push(d(r,u)),e.push(d(a,g)),e.push(d(a,u)),e.push(d(r,u))}}return e}const p=`#version 300 es
in vec2 c_position;
out vec2 v_texCoord;
