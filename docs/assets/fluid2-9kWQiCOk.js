import"./modulepreload-polyfill-B5Qt9EMX.js";import{R as c,j as e,c as S}from"./client-DdK1v10D.js";import{A as C}from"./ArticleLayout-BEy9i2sR.js";import{S as m}from"./Section-C32MxrfX.js";import{H as d}from"./HrefLink-BCA9eVCu.js";import{i as r}from"./react-katex.m-DKdCdCZs.js";import{A as g}from"./AsideCard-6QArDK6n.js";import{A as L,a as D}from"./Articles-DIRYLMHJ.js";import{i as y,j as w,a as h,b as o,l as _,m as E}from"./webgl-BxJ6eXGr.js";import{c as p}from"./math-BinNTQH2.js";import{V as R}from"./visibility-B6XuZukV.js";import{c as j}from"./noise-Cf6lYRUY.js";import{C as A}from"./canvas-CKFiyhQ_.js";import{A as F}from"./arrow-90deg-down-6lHVsvpm.js";import"./bootstrap-CZVVmLqS.js";import"./Layout-Cv6xdGET.js";import"./parse-DZVRAEed.js";import"./mod-DTuQx7wz.js";const b=`#version 300 es
in vec2 a_position;
out vec2 v_texCoord;
...
`;class k extends c.Component{constructor(u){super(u),this.canvas=c.createRef(),this.range=c.createRef(),this.scalarSelect=c.createRef(),this.velocitySelect=c.createRef(),this.scalarTextures=[],this.scalarFramebuffers=[],this.velTextures=[],this.velFramebuffers=[],this.scalarIndex=0,this.velIndex=0,this.needsScalarReset=!0,this.needsVelocityReset=!0,this.animationLoop=()=>{if(this.requestID=window.requestAnimationFrame(this.animationLoop),!this.vis.isVisible()&&this.props.runInBackground!==!0)return;const s=this.cmt.mousePos;if(s){const t=this.props.size;this.gl.useProgram(this.prog_paint_vel),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.velFramebuffers[(this.velIndex+1)%2]),this.gl.uniform2f(this.oldMouseLoc,p(s.previous.x,0,t)/t,p(t-s.previous.y,0,t)/t),this.gl.uniform2f(this.newMouseLoc,p(s.current.x,0,t)/t,p(t-s.current.y,0,t)/t),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.velIndex=(this.velIndex+1)%2}if(this.needsScalarReset){this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.scalarTextures[this.scalarIndex]);const t=parseInt(this.scalarSelect.current?.value),i=new Float32Array(this.props.size*this.props.size);for(let l=0;l<this.props.size;l++){const a=Math.floor(l/(this.props.size/t))%2;for(let n=0;n<this.props.size;n++)Math.floor(n/(this.props.size/t))%2+a==1?i[l*this.props.size+n]=1:i[l*this.props.size+n]=0}y(this.gl,0,0,this.props.size,this.props.size,i),this.needsScalarReset=!1}if(this.needsVelocityReset){this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.velTextures[this.velIndex]);let t;switch(this.velocitySelect.current?.value){case"curlnoise":t=j(3,this.props.size,this.props.size,Math.random()*500);break;default:t=new Float32Array(this.props.size*this.props.size*2);break}w(this.gl,0,0,this.props.size,this.props.size,t),this.needsVelocityReset=!1}this.gl.useProgram(this.prog_advect_scalar);for(let t=0;t<this.range.current.valueAsNumber;t++){const i=this.scalarTextures[this.scalarIndex],l=this.scalarFramebuffers[(this.scalarIndex+1)%2];this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,i),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,l),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.scalarIndex=(this.scalarIndex+1)%2}this.gl.useProgram(this.prog_render),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,null),this.gl.drawArrays(this.gl.TRIANGLES,0,6)}}componentDidMount(){this.gl=this.canvas.current.getContext("webgl2"),this.gl.getExtension("EXT_color_buffer_float");const u=this.gl.createBuffer();this.gl.bindBuffer(this.gl.ARRAY_BUFFER,u),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array([0,0,1,0,0,1,0,1,1,0,1,1]),this.gl.STATIC_DRAW);{this.prog_advect_scalar=h(this.gl,[o(this.gl,this.gl.VERTEX_SHADER,b),o(this.gl,this.gl.FRAGMENT_SHADER,N)]);const s=this.gl.getAttribLocation(this.prog_advect_scalar,"a_position"),t=this.gl.getUniformLocation(this.prog_advect_scalar,"u_scalar_tex"),i=this.gl.getUniformLocation(this.prog_advect_scalar,"u_vel_tex");this.gl.enableVertexAttribArray(s),this.gl.vertexAttribPointer(s,2,this.gl.FLOAT,!1,0,0);for(let l=0;l<2;l++){const a=_(this.gl,this.props.size,this.props.size,new Float32Array(this.props.size*this.props.size));this.scalarTextures.push(a);const n=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,n),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,a,0),this.scalarFramebuffers.push(n)}for(let l=0;l<2;l++){new Int32Array(this.props.size*this.props.size*2);const a=E(this.gl,this.props.size,this.props.size,new Float32Array(this.props.size*this.props.size*2));this.velTextures.push(a);const n=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,n),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,a,0),this.velFramebuffers.push(n)}this.gl.useProgram(this.prog_advect_scalar),this.gl.uniform1i(t,0),this.gl.uniform1i(i,1)}{this.prog_render=h(this.gl,[o(this.gl,this.gl.VERTEX_SHADER,b),o(this.gl,this.gl.FRAGMENT_SHADER,I)]);const s=this.gl.getAttribLocation(this.prog_render,"a_position"),t=this.gl.getUniformLocation(this.prog_render,"u_scalar_tex"),i=this.gl.getUniformLocation(this.prog_render,"u_vel_tex");this.gl.enableVertexAttribArray(s),this.gl.vertexAttribPointer(s,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_render),this.gl.uniform1i(t,0),this.gl.uniform1i(i,1)}{this.prog_paint_vel=h(this.gl,[o(this.gl,this.gl.VERTEX_SHADER,b),o(this.gl,this.gl.FRAGMENT_SHADER,z)]);const s=this.gl.getAttribLocation(this.prog_paint_vel,"a_position"),t=this.gl.getUniformLocation(this.prog_paint_vel,"u_vel_tex");this.newMouseLoc=this.gl.getUniformLocation(this.prog_paint_vel,"u_new_mouse"),this.oldMouseLoc=this.gl.getUniformLocation(this.prog_paint_vel,"u_old_mouse"),this.gl.enableVertexAttribArray(s),this.gl.vertexAttribPointer(s,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_paint_vel),this.gl.uniform1i(t,1)}this.cmt=new A(this.canvas.current),this.vis=new R(this.canvas.current),this.animationLoop()}componentWillUnmount(){window.cancelAnimationFrame(this.requestID),this.cmt.cleanup(),this.vis.cleanup()}render(){return e.jsx("div",{style:this.props.style,className:this.props.className,children:e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-md-8 d-flex",children:[e.jsxs("div",{className:"text-center pb-3",hidden:!this.props.showInstructions,children:[e.jsx(F,{className:"fs-3",style:{transform:"translateY(0.5rem)"}}),e.jsx("span",{className:"fs-5",style:{fontFamily:"Permanent Marker"},children:" Drag to Stir!"})]}),e.jsx("canvas",{className:"border border-dark",ref:this.canvas,height:this.props.size,width:this.props.size})]}),e.jsx("div",{className:"col-md-4",children:e.jsxs("div",{className:"border border-dark p-3 m-3",children:[e.jsx("h6",{children:"Controls"}),e.jsxs("div",{className:"form-group mb-3",children:[e.jsx("label",{className:"form-label",children:"Simulation Speed"}),e.jsx("input",{type:"range",className:"form-range",min:"0",max:"5",step:1,defaultValue:1,ref:this.range})]}),e.jsxs("div",{className:"form-group mb-3",children:[e.jsx("label",{className:"form-label",children:"Scalar Field"}),e.jsxs("select",{className:"form-select mb-3",defaultValue:8,ref:this.scalarSelect,children:[e.jsx("option",{value:1,children:"Empty"}),e.jsx("option",{value:2,children:"Grid 2"}),e.jsx("option",{value:8,children:"Grid 8"}),e.jsx("option",{value:64,children:"Grid 64"})]}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>this.needsScalarReset=!0,children:"Reset Scalar"})]}),e.jsxs("div",{className:"form-group",children:[e.jsx("label",{className:"form-label",children:"Velocity Field"}),e.jsxs("select",{className:"form-select mb-3",defaultValue:8,ref:this.velocitySelect,children:[e.jsx("option",{value:"empty",children:"Empty"}),e.jsx("option",{value:"curlnoise",children:"Curl Noise"})]}),e.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>this.needsVelocityReset=!0,children:"Reset Velocity"})]})]})})]})})}}const x=`#version 300 es
in vec2 c_position;
out vec2 v_texCoord;
