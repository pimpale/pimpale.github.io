import{S as M}from"./style.2e6bf75d.js";import{a as _,b as p,j as a,R as U,F as D}from"./vendor.943a4930.js";import{H as v}from"./HrefLink.f1e4ab75.js";import{A as L}from"./ArticleLayout.c88c37a7.js";import{A as z}from"./AsideCard.9c7dc37c.js";import{o as T,b as S,f as m,e as P,d as I,g as E,c as d,a as c}from"./webgl.9b9ef8e8.js";const f=`#version 300 es
in vec2 a_position;
out vec2 v_texCoord;
...
`;class N extends _.Component{constructor(o){super(o);this.particle_tex_xsize=32,this.particle_tex_ysize=32,this.particle_canvas=_.createRef(),this.render_canvas=_.createRef(),this.range=_.createRef(),this.scalarSelect=_.createRef(),this.velocitySelect=_.createRef(),this.particleStateTextures=[],this.particleStateFramebuffers=[],this.particleMassTextures=[],this.particleMassFramebuffers=[],this.particlePositionTextures=[],this.particlePositionFramebuffers=[],this.particleMomentumTextures=[],this.particleMomentumFramebuffers=[],this.particleStateIndex=0,this.particleMassIndex=0,this.particlePositionIndex=0,this.particleMomentumIndex=0,this.needsReset=!0,this.mousePos=null,this.state_data=new Uint32Array(this.particle_tex_xsize*this.particle_tex_ysize*4),this.mass_data=new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*4),this.position_data=new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*4),this.momentum_data=new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*4),this.animationLoop=()=>{if(this.requestID=window.requestAnimationFrame(this.animationLoop),this.needsReset){const i=new Uint32Array(this.particle_tex_xsize*this.particle_tex_ysize);for(let s=0;s<i.length;s++)i[s]=0;this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleStateTextures[this.particleStateIndex]),T(this.gl,0,0,this.particle_tex_xsize,this.particle_tex_ysize,i);const t=new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize);for(let s=0;s<t.length;s++)t[s]=Math.random()*50;this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMassTextures[this.particleMassIndex]),S(this.gl,0,0,this.particle_tex_xsize,this.particle_tex_ysize,t);const e=new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*2);for(let s=0;s<this.particle_tex_ysize;s++)for(let r=0;r<this.particle_tex_xsize;r++){const n=s*this.particle_tex_xsize+r;e[n*2+0]=r*20+32,e[n*2+1]=s*20+32}this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particlePositionTextures[this.particlePositionIndex]),m(this.gl,0,0,this.particle_tex_xsize,this.particle_tex_ysize,e);const l=new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*2);for(let s=0;s<this.particle_tex_ysize;s++)for(let r=0;r<this.particle_tex_xsize;r++){const n=s*this.particle_tex_xsize+r;l[n*2+0]=(Math.random()-.5)*0,l[n*2+1]=(Math.random()-.5)*0}this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMomentumTextures[this.particleMomentumIndex]),m(this.gl,0,0,this.particle_tex_xsize,this.particle_tex_ysize,l),this.needsReset=!1}for(let i=0;i<this.range.current.valueAsNumber;i++){{this.gl.useProgram(this.prog_handle_state),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMassTextures[this.particleMassIndex]),this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particlePositionTextures[this.particlePositionIndex]),this.gl.activeTexture(this.gl.TEXTURE3),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMomentumTextures[this.particleMomentumIndex]);const t=this.particleStateTextures[this.particleStateIndex],e=this.particleStateFramebuffers[(this.particleStateIndex+1)%2];this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,t),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.particleStateIndex=(this.particleStateIndex+1)%2}{this.gl.useProgram(this.prog_handle_mass),this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleStateTextures[this.particleStateIndex]);const t=this.particleMassTextures[this.particleMassIndex],e=this.particleMassFramebuffers[(this.particleMassIndex+1)%2];this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,t),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.particleMassIndex=(this.particleMassIndex+1)%2}{this.gl.useProgram(this.prog_apply_gravity),this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleStateTextures[this.particleStateIndex]),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMassTextures[this.particleMassIndex]),this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particlePositionTextures[this.particlePositionIndex]);const t=this.particleMomentumTextures[this.particleMomentumIndex],e=this.particleMomentumFramebuffers[(this.particleMomentumIndex+1)%2];this.gl.activeTexture(this.gl.TEXTURE3),this.gl.bindTexture(this.gl.TEXTURE_2D,t),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.particleMomentumIndex=(this.particleMomentumIndex+1)%2}{this.gl.useProgram(this.prog_move_particle),this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleStateTextures[this.particleStateIndex]),this.gl.activeTexture(this.gl.TEXTURE1),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMassTextures[this.particleMassIndex]),this.gl.activeTexture(this.gl.TEXTURE3),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleMomentumTextures[this.particleMomentumIndex]);const t=this.particlePositionTextures[this.particlePositionIndex],e=this.particlePositionFramebuffers[(this.particlePositionIndex+1)%2];this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,t),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.drawArrays(this.gl.TRIANGLES,0,6),this.particlePositionIndex=(this.particlePositionIndex+1)%2}}this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.particleStateFramebuffers[this.particleStateIndex]),this.gl.readPixels(0,0,this.particle_tex_xsize,this.particle_tex_ysize,this.gl.RGBA_INTEGER,this.gl.UNSIGNED_INT,this.state_data),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.particleMassFramebuffers[this.particleMassIndex]),this.gl.readPixels(0,0,this.particle_tex_xsize,this.particle_tex_ysize,this.gl.RGBA,this.gl.FLOAT,this.mass_data),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.particlePositionFramebuffers[this.particlePositionIndex]),this.gl.readPixels(0,0,this.particle_tex_xsize,this.particle_tex_ysize,this.gl.RGBA,this.gl.FLOAT,this.position_data),this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,this.particleMomentumFramebuffers[this.particleMomentumIndex]),this.gl.readPixels(0,0,this.particle_tex_xsize,this.particle_tex_ysize,this.gl.RGBA,this.gl.FLOAT,this.momentum_data),this.draw(this.state_data,this.mass_data,this.position_data,this.momentum_data)},this.editData=null,this.handleMouseDown=i=>{const t=this.getMousePos(this.render_canvas.current,i);this.mousePos={current:t,previous:t};for(let e=0;e<this.position_data.length/4;e++)if(this.state_data[e*4]==0){const l=this.calcRadius(this.mass_data[e*4]);if(Math.hypot(t.x-this.position_data[e*4+0],t.y-this.position_data[e*4+1])<l){this.editData={id:e,dragging:t},this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleStateTextures[this.particleStateIndex]),T(this.gl,e%this.particle_tex_xsize,e/this.particle_tex_xsize,1,1,Uint32Array.from([1]));break}}},this.handleMouseUp=i=>{var t;((t=this.editData)==null?void 0:t.dragging)&&(this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particlePositionTextures[this.particlePositionIndex]),m(this.gl,this.editData.id%this.particle_tex_xsize,this.editData.id/this.particle_tex_xsize,1,1,Float32Array.from([this.editData.dragging.x,this.editData.dragging.y])),this.gl.activeTexture(this.gl.TEXTURE0),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particleStateTextures[this.particleStateIndex]),T(this.gl,this.editData.id%this.particle_tex_xsize,this.editData.id/this.particle_tex_xsize,1,1,Uint32Array.from([0])),this.editData.dragging=null),this.mousePos=null},this.handleMouseMove=i=>{var e;if(!this.mousePos)return;const t=this.getMousePos(this.render_canvas.current,i);this.mousePos={current:t,previous:this.mousePos.current},((e=this.editData)==null?void 0:e.dragging)&&(this.editData.dragging=t,this.gl.activeTexture(this.gl.TEXTURE2),this.gl.bindTexture(this.gl.TEXTURE_2D,this.particlePositionTextures[this.particlePositionIndex]),m(this.gl,this.editData.id%this.particle_tex_xsize,this.editData.id/this.particle_tex_xsize,1,1,Float32Array.from([this.editData.dragging.x,this.editData.dragging.y])))},this.discardTouchEvent=i=>i.preventDefault(),this.calcRadius=i=>1.5*Math.sqrt(i)+5,this.draw=(i,t,e,l)=>{var n;const s=this.render_canvas.current,r=this.render_canvas.current.getContext("2d");r.fillStyle="#000000",r.fillRect(0,0,s.width,s.height),r.strokeStyle="#FF0000";for(let h=0;h<e.length/4;h++){let F=i[h*4],u=e[h*4+0],g=e[h*4+1],x=t[h*4],b=Math.sqrt(x);switch(r.beginPath(),r.arc(u,g,b,0,2*Math.PI),F){case 0:r.fillStyle="#FFFFFF";break;default:r.fillStyle="#FF0000";break}r.fill(),r.beginPath(),r.moveTo(u,g);let y=l[h*4+0]/x,A=l[h*4+1]/x;r.lineTo(u+y,g+A),r.stroke(),h==((n=this.editData)==null?void 0:n.id)&&(r.strokeStyle="#0000FF",r.beginPath(),r.arc(u,g,this.calcRadius(x),0,2*Math.PI),r.stroke(),r.strokeStyle="#FF0000")}}}componentDidMount(){this.gl=this.particle_canvas.current.getContext("webgl2"),this.gl.getExtension("EXT_color_buffer_float");for(let i=0;i<2;i++){const t=P(this.gl,this.particle_tex_xsize,this.particle_tex_ysize);this.particleStateTextures.push(t);const e=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,t,0),this.particleStateFramebuffers.push(e)}for(let i=0;i<2;i++){const t=I(this.gl,this.particle_tex_xsize,this.particle_tex_ysize,new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize));this.particleMassTextures.push(t);const e=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,t,0),this.particleMassFramebuffers.push(e)}for(let i=0;i<2;i++){const t=E(this.gl,this.particle_tex_xsize,this.particle_tex_ysize,new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*2));this.particlePositionTextures.push(t);const e=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,t,0),this.particlePositionFramebuffers.push(e)}for(let i=0;i<2;i++){const t=E(this.gl,this.particle_tex_xsize,this.particle_tex_ysize,new Float32Array(this.particle_tex_xsize*this.particle_tex_ysize*2));this.particleMomentumTextures.push(t);const e=this.gl.createFramebuffer();this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,t,0),this.particleMomentumFramebuffers.push(e)}const o=this.gl.createBuffer();this.gl.bindBuffer(this.gl.ARRAY_BUFFER,o),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array([0,0,1,0,0,1,0,1,1,0,1,1]),this.gl.STATIC_DRAW);{this.prog_apply_gravity=d(this.gl,[c(this.gl,this.gl.VERTEX_SHADER,f),c(this.gl,this.gl.FRAGMENT_SHADER,X)]);const i=this.gl.getAttribLocation(this.prog_apply_gravity,"a_position"),t=this.gl.getUniformLocation(this.prog_apply_gravity,"u_particle_state_tex"),e=this.gl.getUniformLocation(this.prog_apply_gravity,"u_particle_mass_tex"),l=this.gl.getUniformLocation(this.prog_apply_gravity,"u_particle_position_tex"),s=this.gl.getUniformLocation(this.prog_apply_gravity,"u_particle_momentum_tex");this.gl.enableVertexAttribArray(i),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,o),this.gl.vertexAttribPointer(i,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_apply_gravity),this.gl.uniform1i(t,0),this.gl.uniform1i(e,1),this.gl.uniform1i(l,2),this.gl.uniform1i(s,3)}{this.prog_move_particle=d(this.gl,[c(this.gl,this.gl.VERTEX_SHADER,f),c(this.gl,this.gl.FRAGMENT_SHADER,w)]);const i=this.gl.getAttribLocation(this.prog_move_particle,"a_position"),t=this.gl.getUniformLocation(this.prog_move_particle,"u_particle_state_tex"),e=this.gl.getUniformLocation(this.prog_move_particle,"u_particle_mass_tex"),l=this.gl.getUniformLocation(this.prog_move_particle,"u_particle_position_tex"),s=this.gl.getUniformLocation(this.prog_move_particle,"u_particle_momentum_tex");this.gl.enableVertexAttribArray(i),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,o),this.gl.vertexAttribPointer(i,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_move_particle),this.gl.uniform1i(t,0),this.gl.uniform1i(e,1),this.gl.uniform1i(l,2),this.gl.uniform1i(s,3)}{this.prog_handle_mass=d(this.gl,[c(this.gl,this.gl.VERTEX_SHADER,f),c(this.gl,this.gl.FRAGMENT_SHADER,C)]);const i=this.gl.getAttribLocation(this.prog_handle_mass,"a_position"),t=this.gl.getUniformLocation(this.prog_handle_mass,"u_particle_state_tex"),e=this.gl.getUniformLocation(this.prog_handle_mass,"u_particle_mass_tex");this.gl.enableVertexAttribArray(i),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,o),this.gl.vertexAttribPointer(i,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_handle_mass),this.gl.uniform1i(t,0),this.gl.uniform1i(e,1)}{this.prog_handle_state=d(this.gl,[c(this.gl,this.gl.VERTEX_SHADER,f),c(this.gl,this.gl.FRAGMENT_SHADER,B)]);const i=this.gl.getAttribLocation(this.prog_handle_state,"a_position"),t=this.gl.getUniformLocation(this.prog_handle_state,"u_particle_state_tex"),e=this.gl.getUniformLocation(this.prog_handle_state,"u_particle_mass_tex"),l=this.gl.getUniformLocation(this.prog_handle_state,"u_particle_position_tex"),s=this.gl.getUniformLocation(this.prog_handle_state,"u_particle_momentum_tex");this.gl.enableVertexAttribArray(i),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,o),this.gl.vertexAttribPointer(i,2,this.gl.FLOAT,!1,0,0),this.gl.useProgram(this.prog_handle_state),this.gl.uniform1i(t,0),this.gl.uniform1i(e,1),this.gl.uniform1i(l,2),this.gl.uniform1i(s,3)}this.render_canvas.current.addEventListener("pointerdown",this.handleMouseDown),this.render_canvas.current.addEventListener("pointermove",this.handleMouseMove),window.addEventListener("pointerup",this.handleMouseUp),this.render_canvas.current.addEventListener("touchstart",this.discardTouchEvent),this.render_canvas.current.addEventListener("touchmove",this.discardTouchEvent),this.render_canvas.current.addEventListener("touchend",this.discardTouchEvent),this.render_canvas.current.addEventListener("touchcancel",this.discardTouchEvent),this.animationLoop()}getMousePos(o,i){const t=o.getBoundingClientRect(),e=o.width/t.width,l=o.height/t.height;return{x:(i.clientX-t.left)*e,y:(i.clientY-t.top)*l}}componentWillUnmount(){this.render_canvas.current.removeEventListener("pointerdown",this.handleMouseDown),this.render_canvas.current.removeEventListener("pointermove",this.handleMouseMove),window.removeEventListener("pointerup",this.handleMouseUp),this.render_canvas.current.removeEventListener("touchstart",this.discardTouchEvent),this.render_canvas.current.removeEventListener("touchmove",this.discardTouchEvent),this.render_canvas.current.removeEventListener("touchend",this.discardTouchEvent),this.render_canvas.current.removeEventListener("touchcancel",this.discardTouchEvent),window.cancelAnimationFrame(this.requestID),this.gl.getExtension("WEBGL_lose_context").loseContext()}render(){return p("div",{style:this.props.style,className:this.props.className,children:[a("div",{children:a("canvas",{className:"border border-dark",ref:this.particle_canvas,height:this.particle_tex_xsize,width:this.particle_tex_ysize,hidden:!0})}),p("div",{className:"row",children:[a("div",{className:"col-md-8 d-flex",children:a("canvas",{className:"border border-dark",ref:this.render_canvas,height:this.props.size,width:this.props.size})}),a("div",{className:"col-md-4",children:p("div",{className:"border border-dark p-3 m-3",children:[a("h6",{children:"Controls"}),p("div",{className:"form-group mb-3",children:[a("label",{className:"form-label",children:"Simulation Speed"}),a("input",{type:"range",className:"form-range",min:"0",max:"5",step:1,defaultValue:1,ref:this.range})]}),p("div",{className:"form-group mb-3",children:[a("label",{className:"form-label",children:"Scalar Field"}),p("select",{className:"form-select mb-3",defaultValue:8,ref:this.scalarSelect,children:[a("option",{value:32,children:"2^6: 64"}),a("option",{value:32,children:"2^6: 64"}),a("option",{value:16,children:"2^8 64"})]}),a("button",{className:"btn btn-primary btn-sm",onClick:()=>this.needsReset=!0,children:"Reset"})]})]})})]})]})}}const G=()=>a(L,{children:({Citation:R,CitationBank:o})=>a(D,{children:p(M,{name:"Spacewar",id:"spacewar",children:[a("p",{children:a(v,{href:"https://github.com/pimpale/spacewar"})}),a("p",{children:a(v,{href:"https://github.com/pimpale/GravitySimulator"})}),a(z,{title:"Canvas Setup",id:"canvas-setup-demo",children:a(N,{className:"mx-auto",style:{maxWidth:"50em"},size:512})})]})})});U.render(a(_.StrictMode,{children:a(G,{})}),document.getElementById("root"));
