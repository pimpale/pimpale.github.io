import{S as m}from"./style.2ef3c53f.js";import{a as h,j as e,b as i,R as z,F as M,A as f,S as R,c as y,i as g}from"./vendor.3c91fdf8.js";import{A as N}from"./ArticleLayout.3020cd62.js";import{H as v}from"./HrefLink.8d7e5345.js";import{f as A}from"./load.41e68f77.js";import{c as p,A as E}from"./math.8e9320ae.js";import{c as u,a as l,o as F,b as T,d as b,e as P,f as C,g as D}from"./webgl.9b9ef8e8.js";import{c as S}from"./noise.b516de31.js";const I=`#version 300 es
in vec2 a_position;
out vec2 v_texCoord;
void main() {
...
`;class X extends h.Component{constructor(o){super(o);this.canvas=h.createRef(),this.animationLoop=()=>{this.requestID=window.requestAnimationFrame(this.animationLoop),this.gl.useProgram(this.program),this.gl.bindVertexArray(this.vao),this.gl.drawArrays(this.gl.TRIANGLES,0,6)}}componentDidMount(){this.gl=this.canvas.current.getContext("webgl2"),this.program=u(this.gl,[l(this.gl,this.gl.VERTEX_SHADER,I),l(this.gl,this.gl.FRAGMENT_SHADER,G)]);const o=this.gl.createBuffer();this.gl.bindBuffer(this.gl.ARRAY_BUFFER,o),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array([0,0,1,0,0,1,0,1,1,0,1,1]),this.gl.STATIC_DRAW);const t=this.gl.getAttribLocation(this.program,"a_position");this.vao=this.gl.createVertexArray(),this.gl.bindVertexArray(this.vao),this.gl.enableVertexAttribArray(t),this.gl.vertexAttribPointer(t,2,this.gl.FLOAT,!1,0,0),this.animationLoop()}componentWillUnmount(){window.cancelAnimationFrame(this.requestID),this.gl.getExtension("WEBGL_lose_context").loseContext()}render(){return e("canvas",{style:this.props.style,className:this.props.className,ref:this.canvas,height:this.props.size,width:this.props.size})}}const L=`#version 300 es
in vec2 c_position;
out vec2 v_texCoord;
