...
const LogosPage = () => <ArticleLayout>{
  ({ Citation, CitationBank }) => <>
    <Section id="overview" name="Overview">
      <p>En arkhêi ên ho Lógos, kaì ho Lógos ên pròs tòn Theón, kaì Theòs ên ho Lógos.
      - John 1:1</p>
      <p>En arkhêi ên ho Lógos, kaì ho Lógos ên pròs tòn Theón, kaì Theòs ên ho Lógos.
      In beginning was the Word, and the Word was with the God, and God was the Word</p>
      <h4>In the beginning was the word.</h4>
      ...
      <h4>And the word was with God.</h4>
