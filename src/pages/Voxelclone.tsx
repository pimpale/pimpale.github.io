...
const VoxelclonePage = () => <ArticleLayout>{
  ({ Citation, CitationBank }) => <>
    ...
    <Section id="voxelclone" name="Voxelclone">
      ...
      <h4>Motivation</h4>
      <p>
        I created Voxelclone mostly for fun, but also to try my hand at writing a very simple intepreter in C.
      ...
      <p>
        ...
        This means that a program written in Voxelclone treats its own code as data.
        Lisp accomplishes this using lists, which means any Lisp code can be represented as a list.
        Voxelclone uses strings for this purpose.
      </p>
      <p>
        Voxelclone syntax uses code stored in strings heavily, for loops, if statements, and other control structures.
      ...
      <p>
        It's named Voxelclone due to its stack based nature.
        Just as a voxelclone has many delicious pasta layers, the executing program will also have layers of tasty strings and numbers.
      </p>
      <p>
        The logo is remniscent of a famous cartoon cat who is notoriously fond of voxelclone.
      </p>
    </Section>
    <Section id="usage" name="How to Use">
      <h4>Building the Interpreter</h4>
      <p>
        The source code is located here: <HrefLink href="https://github.com/pimpale/voxelclone" />
      </p>
      <p>
      ...
      <p>
        After compilation, the interpreter binary will be located at <code>obj/voxelclone</code>.
      </p>
      <p>
      ...
      <p>
        To execute a Voxelclone script, do:
      </p>
      <SyntaxHighligher className="mx-5" showLineNumbers style={a11yDark}>
        {"./obj/voxelclone <FILENAME>"}
      </SyntaxHighligher>
    </Section>
    ...
    <Section id="guide" name="Language Guide">
      ...
      <h4>Eval</h4>
      <p>
        A very important function in Voxelclone is <code>eval</code>, since it's used as a building block for many other control statements.
        This function takes in a string stored on the stack, and evaluates it as Voxelclone source code.
      </p>
      <p>
      ...
      <h4>If Statements</h4>
      <p>
        If statements are actually just a regular function, like everything else in voxelclone.
        In Voxelclone, like C, 0 is considered as false, and any other number is considered true.
      </p>
      <p>
      ...
      <h4>Fizzbuzz</h4>
      <p>
        Here's how to write the classic Fizzbuzz program in Voxelclone:
      </p>
      <SyntaxHighligher className="mx-5" showLineNumbers style={a11yDark}>{outdent`
        100
        1 ( # loop
    ...
    <Section id="conclusion" name="Conclusion">
      <p>
        While Voxelclone is a pretty simple language, it's also incredibly slow, and pretty much useless for production purposes.
      ...
      <ul>
        <li>
          <p>
            ...
            Voxelclone is not a particularly legible language.
            ...
            Voxelclone also has the disadvantage that math operations aren't infixed.
          </p>
          <p>
            I think Lisp actually does a fairly good job with this (definitely better than Voxelclone, since functions go at the front),
      ...
      <h4>Next Steps</h4>
      <p>
        I think I'm pretty much finished with Voxelclone, and I don't intend on developing it further.
