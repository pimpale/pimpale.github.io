...
let ParserRules = [
    ...
    {"name": "inf_vp", "symbols": ["vb_vbg_cl", "not?", "adjunct_list_vbg_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["vb_vbn_cl", "not?", "adjunct_list_vbn_cl"], "postprocess": nt("inf_vp")},
    ...
    {"name": "vbg_vp", "symbols": ["vbg_vbg_cl", "not?", "adjunct_list_vbg_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["vbg_vbn_cl", "not?", "adjunct_list_vbn_cl"], "postprocess": nt("vbg_vp")},
    ...
    {"name": "vbn_vp", "symbols": ["vbn_vbg_cl", "not?", "adjunct_list_vbg_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["vbn_vbn_cl", "not?", "adjunct_list_vbn_cl"], "postprocess": nt("vbn_vp")},
    ...
    {"name": "adjunct_list_ap_ap_moved", "symbols": ["ap", "adjunct_list"], "postprocess": nt("adjunct_list_ap_ap_moved")},
    {"name": "adjunct_list_to_inf_cl_ap_moved", "symbols": ["adjunct_list_to_inf_cl"], "postprocess": nt("adjunct_list_to_inf_cl_ap_moved")},
    {"name": "adjunct_list_to_inf_cl_ap_moved", "symbols": ["adjunct", "adjunct_list_to_inf_cl_ap_moved"], "postprocess": nt("adjunct_list_to_inf_cl_ap_moved")},
    {"name": "adjunct_list_to_inf_cl_ap_moved", "symbols": ["to_inf_cl_ap_moved", "adjunct_list"], "postprocess": nt("adjunct_list_to_inf_cl_ap_moved")},
    {"name": "adjunct_list_bare_inf_cl_ap_moved", "symbols": ["adjunct_list_bare_inf_cl"], "postprocess": nt("adjunct_list_bare_inf_cl_ap_moved")},
    {"name": "adjunct_list_bare_inf_cl_ap_moved", "symbols": ["bare_inf_cl_ap_moved", "adjunct_list"], "postprocess": nt("adjunct_list_bare_inf_cl_ap_moved")},
    {"name": "adjunct_list_declarative_cl_ap_moved", "symbols": ["adjunct", "adjunct_list_declarative_cl"], "postprocess": nt("adjunct_list_declarative_cl_ap_moved")},
    {"name": "adjunct_list_declarative_cl_ap_moved", "symbols": ["declarative_cl", "adjunct_list"], "postprocess": nt("adjunct_list_declarative_cl_ap_moved")},
    {"name": "adjunct_list_exclamative_cl", "symbols": ["adjunct", "adjunct_list_exclamative_cl"], "postprocess": nt("adjunct_list_exclamative_cl")},
    {"name": "adjunct_list_exclamative_cl", "symbols": ["exclamative_cl", "adjunct_list"], "postprocess": nt("adjunct_list_exclamative_cl")},
    {"name": "adjunct_list_interrogative_cl", "symbols": ["adjunct", "adjunct_list_interrogative_cl"], "postprocess": nt("adjunct_list_interrogative_cl")},
    {"name": "adjunct_list_interrogative_cl", "symbols": ["interrogative_cl", "adjunct_list"], "postprocess": nt("adjunct_list_interrogative_cl")},
    ...
    {"name": "adjunct_list_np_np", "symbols": ["np", "adjunct_list_np"], "postprocess": nt("adjunct_list_np_np")},
    {"name": "adjunct_list_np_np", "symbols": ["to", "np", "adjunct_list_np"], "postprocess": nt("adjunct_list_np_np")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "modal", "not?", "bare_inf_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf", "not?", "adjunct_list_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_ap", "not?", "adjunct_list_ap_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_to_inf_cl", "not?", "adjunct_list_to_inf_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_declarative_cl", "not?", "adjunct_list_declarative_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_exclamative_cl", "not?", "adjunct_list_exclamative_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_interrogative_cl", "not?", "adjunct_list_interrogative_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["vbf_vbg_cl", "not?", "vbg_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["vbf_vbn_cl", "not?", "vbn_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np", "not?", "adjunct_list_np_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_ap", "not?", "adjunct_list_np_ap_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_declarative_cl", "not?", "adjunct_list_np_declarative_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_ap_moved"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp_ap_moved", "symbols": ["advp?", "vbf_np_np", "not?", "adjunct_list_np_np_ap_moved"], "postprocess": nt("fin_vp")},
