...
let ParserRules = [
    ...
    {"name": "question_cl", "symbols": ["how", "subj_aux_inv_cl_adjp_moved"], "postprocess": nt("question_cl")},
    {"name": "subj_aux_inv_cl", "symbols": ["modal", "not?", "np", "bare_inf_cl"], "postprocess": nt("subj_aux_inv_cl")},
    {"name": "subj_aux_inv_cl", "symbols": ["be_fin", "not?", "np", "adjp"], "postprocess": nt("subj_aux_inv_cl")},
    ...
    {"name": "subj_aux_inv_cl_np_moved", "symbols": ["be_fin", "not?", "adjp"], "postprocess": nt("subj_aux_inv_cl_np_moved")},
    ...
    {"name": "subj_aux_inv_cl_adjp_moved", "symbols": ["modal", "not?", "np", "bare_inf_cl_adjp_moved"], "postprocess": nt("subj_aux_inv_cl_adjp_moved")},
    {"name": "subj_aux_inv_cl_adjp_moved", "symbols": ["be_fin", "not?", "np"], "postprocess": nt("subj_aux_inv_cl_adjp_moved")},
    {"name": "subj_aux_inv_cl_adjp_moved", "symbols": ["vbf_vbg_cl", "not?", "np", "vbg_cl_adjp_moved"], "postprocess": nt("subj_aux_inv_cl_adjp_moved")},
    {"name": "subj_aux_inv_cl_adjp_moved", "symbols": ["vbf_vbn_cl", "not?", "np", "vbn_cl_adjp_moved"], "postprocess": nt("subj_aux_inv_cl_adjp_moved")},
    {"name": "subj_aux_inv_cl_adjp_moved", "symbols": ["do_fin", "not?", "np", "bare_inf_cl_adjp_moved"], "postprocess": nt("subj_aux_inv_cl_adjp_moved")},
    ...
    {"name": "adjunct_list_adjp", "symbols": ["adjunct", "adjunct_list_adjp"], "postprocess": nt("adjunct_list_adjp")},
    {"name": "adjunct_list_adjp", "symbols": ["adjp", "adjunct_list"], "postprocess": nt("adjunct_list_adjp")},
    ...
    {"name": "adjunct_list_np_adjp", "symbols": ["adjunct", "adjunct_list_np_adjp"], "postprocess": nt("adjunct_list_np_adjp")},
    {"name": "adjunct_list_np_adjp", "symbols": ["np", "adjunct_list_adjp"], "postprocess": nt("adjunct_list_np_adjp")},
    {"name": "adjunct_list_np_adjp", "symbols": ["adjp", "adjunct_list_np"], "postprocess": nt("adjunct_list_np_adjp")},
    {"name": "adjunct_list_np_to_inf_cl", "symbols": ["adjunct", "adjunct_list_np_to_inf_cl"], "postprocess": nt("adjunct_list_np_adjp")},
    {"name": "adjunct_list_np_to_inf_cl", "symbols": ["np", "adjunct_list_to_inf_cl"], "postprocess": nt("adjunct_list_np_adjp")},
    {"name": "adjunct_list_np_bare_inf_cl", "symbols": ["adjunct", "adjunct_list_np_bare_inf_cl"], "postprocess": nt("adjunct_list_np_adjp")},
    {"name": "adjunct_list_np_bare_inf_cl", "symbols": ["np", "adjunct_list_bare_inf_cl"], "postprocess": nt("adjunct_list_np_adjp")},
    ...
    {"name": "fin_vp", "symbols": ["advp_vp?", "modal", "not?", "bare_inf_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf", "not?", "adjunct_list"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_to_inf_cl", "not?", "adjunct_list_to_inf_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_exclamative_cl", "not?", "adjunct_list_exclamative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_interrogative_cl", "not?", "adjunct_list_interrogative_cl"], "postprocess": nt("fin_vp")},
    ...
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np", "not?", "adjunct_list_np"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl"], "postprocess": nt("fin_vp")},
    {"name": "fin_vp", "symbols": ["advp_vp?", "vbf_np_np", "not?", "adjunct_list_np_np"], "postprocess": nt("fin_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb", "not?", "adjunct_list"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_to_inf_cl", "not?", "adjunct_list_to_inf_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_exclamative_cl", "not?", "adjunct_list_exclamative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_interrogative_cl", "not?", "adjunct_list_interrogative_cl"], "postprocess": nt("inf_vp")},
    ...
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np", "not?", "adjunct_list_np"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl"], "postprocess": nt("inf_vp")},
    {"name": "inf_vp", "symbols": ["advp_vp?", "vb_np_np", "not?", "adjunct_list_np_np"], "postprocess": nt("inf_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg", "not?", "adjunct_list"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_to_inf_cl", "not?", "adjunct_list_to_inf_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_exclamative_cl", "not?", "adjunct_list_exclamative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_interrogative_cl", "not?", "adjunct_list_interrogative_cl"], "postprocess": nt("vbg_vp")},
    ...
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np", "not?", "adjunct_list_np"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl"], "postprocess": nt("vbg_vp")},
    {"name": "vbg_vp", "symbols": ["advp_vp?", "vbg_np_np", "not?", "adjunct_list_np_np"], "postprocess": nt("vbg_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn", "not?", "adjunct_list"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_to_inf_cl", "not?", "adjunct_list_to_inf_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_exclamative_cl", "not?", "adjunct_list_exclamative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_interrogative_cl", "not?", "adjunct_list_interrogative_cl"], "postprocess": nt("vbn_vp")},
    ...
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np", "not?", "adjunct_list_np"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl"], "postprocess": nt("vbn_vp")},
    {"name": "vbn_vp", "symbols": ["advp_vp?", "vbn_np_np", "not?", "adjunct_list_np_np"], "postprocess": nt("vbn_vp")},
    ...
    {"name": "adjunct_list_adjp_np_moved", "symbols": ["adjunct", "adjunct_list_adjp_np_moved"], "postprocess": nt("adjunct_list_adjp_np_moved")},
    {"name": "adjunct_list_adjp_np_moved", "symbols": ["adjp", "adjunct_list_np_moved"], "postprocess": nt("adjunct_list_adjp_np_moved")},
    {"name": "adjunct_list_adjp_np_moved", "symbols": ["adjp_np_moved", "adjunct_list"], "postprocess": nt("adjunct_list_adjp_np_moved")},
    ...
    {"name": "adjunct_list_np_adjp_np_moved", "symbols": ["adjunct", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("adjunct_list_np_adjp_np_moved")},
    {"name": "adjunct_list_np_adjp_np_moved", "symbols": ["adjunct_np_moved", "adjunct_list_np_adjp"], "postprocess": nt("adjunct_list_np_adjp_np_moved")},
    {"name": "adjunct_list_np_adjp_np_moved", "symbols": ["np", "adjunct_list_adjp_np_moved"], "postprocess": nt("adjunct_list_np_adjp_np_moved")},
    {"name": "adjunct_list_np_adjp_np_moved", "symbols": ["adjp", "adjunct_list_np_np_moved"], "postprocess": nt("adjunct_list_np_adjp_np_moved")},
    {"name": "adjunct_list_np_adjp_np_moved", "symbols": ["adjp_np_moved", "adjunct_list_np"], "postprocess": nt("adjunct_list_np_adjp_np_moved")},
    ...
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "modal", "not?", "bare_inf_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf", "not?", "adjunct_list_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_to_inf_cl", "not?", "adjunct_list_to_inf_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    ...
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np", "not?", "adjunct_list_np_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "fin_vp_np_moved", "symbols": ["advp_vp?", "vbf_np_np", "not?", "adjunct_list_np_np_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb", "not?", "adjunct_list_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_to_inf_cl", "not?", "adjunct_list_to_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np", "not?", "adjunct_list_np_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "inf_vp_np_moved", "symbols": ["advp_vp?", "vb_np_np", "not?", "adjunct_list_np_np_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg", "not?", "adjunct_list_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_to_inf_cl", "not?", "adjunct_list_to_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np", "not?", "adjunct_list_np_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbg_vp_np_moved", "symbols": ["advp_vp?", "vbg_np_np", "not?", "adjunct_list_np_np_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn", "not?", "adjunct_list_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_to_inf_cl", "not?", "adjunct_list_to_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np", "not?", "adjunct_list_np_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_that_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "vbn_vp_np_moved", "symbols": ["advp_vp?", "vbn_np_np", "not?", "adjunct_list_np_np_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    {"name": "adjunct_list_adjp_moved", "symbols": ["adjunct_list"], "postprocess": nt("adjunct_list_adjp_moved")},
    {"name": "adjunct_list_adjp_adjp_moved", "symbols": ["adjunct_list_adjp"], "postprocess": nt("adjunct_list_adjp_adjp_moved")},
    {"name": "adjunct_list_adjp_adjp_moved", "symbols": ["adjunct_list"], "postprocess": nt("adjunct_list_adjp_adjp_moved")},
    ...
    {"name": "adjunct_list_np_adjp_adjp_moved", "symbols": ["adjunct_list_np_adjp"], "postprocess": nt("adjunct_list_np_adjp_adjp_moved_")},
    {"name": "adjunct_list_np_adjp_adjp_moved", "symbols": ["adjunct_list_np"], "postprocess": nt("adjunct_list_np_adjp_adjp_moved_")},
    ...
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "modal", "not?", "bare_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["vbf_vbg_cl", "not?", "vbg_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["vbf_vbn_cl", "not?", "vbn_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp_vp?", "vbf_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["vb_vbg_cl", "not?", "vbg_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["vb_vbn_cl", "not?", "vbn_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp_vp?", "vb_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["vbn_vbg_cl", "not?", "vbg_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["vbn_vbn_cl", "not?", "vbn_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp_vp?", "vbn_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["vbg_vbg_cl", "not?", "vbg_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["vbg_vbn_cl", "not?", "vbn_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp_vp?", "vbg_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    ...
    {"name": "exclamative_cl", "symbols": ["how", "advp_vp", "fin_cl"], "postprocess": nt("exclamative_cl")},
    {"name": "exclamative_cl", "symbols": ["how", "adjp", "np", "fin_vp_adjp_moved"], "postprocess": nt("exclamative_cl")},
    ...
    {"name": "vb_adjp", "symbols": [vb_adjp], "postprocess": t("vb_adjp")},
    ...
    {"name": "vb_np_adjp", "symbols": [vb_np_adjp], "postprocess": t("vb_np_adjp")},
    ...
    {"name": "vbg_adjp", "symbols": [vbg_adjp], "postprocess": t("vbg_adjp")},
    ...
    {"name": "vbg_np_adjp", "symbols": [vbg_np_adjp], "postprocess": t("vbg_np_adjp")},
    ...
    {"name": "vbn_adjp", "symbols": [vbn_adjp], "postprocess": t("vbn_adjp")},
    ...
    {"name": "vbn_np_adjp", "symbols": [vbn_np_adjp], "postprocess": t("vbn_np_adjp")},
    ...
    {"name": "vbf_adjp", "symbols": [vbf_adjp], "postprocess": t("vbf_adjp")},
    ...
    {"name": "vbf_np_adjp", "symbols": [vbf_np_adjp], "postprocess": t("vbf_np_adjp")},
