...
let ParserRules = [
    ...
    {"name": "fin_vp", "symbols": ["advp?", "vbf_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("fin_vp")},
    ...
    {"name": "fin_vp", "symbols": ["advp?", "vbf_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("fin_vp")},
    ...
    {"name": "inf_vp", "symbols": ["advp?", "vb_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("inf_vp")},
    ...
    {"name": "inf_vp", "symbols": ["advp?", "vb_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("inf_vp")},
    ...
    {"name": "vbg_vp", "symbols": ["advp?", "vbg_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("vbg_vp")},
    ...
    {"name": "vbg_vp", "symbols": ["advp?", "vbg_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("vbg_vp")},
    ...
    {"name": "vbn_vp", "symbols": ["advp?", "vbn_adjp", "not?", "adjunct_list_adjp"], "postprocess": nt("vbn_vp")},
    ...
    {"name": "vbn_vp", "symbols": ["advp?", "vbn_np_adjp", "not?", "adjunct_list_np_adjp"], "postprocess": nt("vbn_vp")},
    ...
    {"name": "fin_vp_np_moved", "symbols": ["advp?", "vbf_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    ...
    {"name": "fin_vp_np_moved", "symbols": ["advp?", "vbf_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("fin_vp_np_moved")},
    ...
    {"name": "inf_vp_np_moved", "symbols": ["advp?", "vb_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "inf_vp_np_moved", "symbols": ["advp?", "vb_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "vbg_vp_np_moved", "symbols": ["advp?", "vbg_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "vbg_vp_np_moved", "symbols": ["advp?", "vbg_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "vbn_vp_np_moved", "symbols": ["advp?", "vbn_adjp", "not?", "adjunct_list_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "vbn_vp_np_moved", "symbols": ["advp?", "vbn_np_adjp", "not?", "adjunct_list_np_adjp_np_moved"], "postprocess": nt("inf_vp_np_moved")},
    ...
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "modal", "not?", "bare_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    ...
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "fin_vp_adjp_moved", "symbols": ["advp?", "vbf_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("fin_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    ...
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "inf_vp_adjp_moved", "symbols": ["advp?", "vb_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("inf_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    ...
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbn_vp_adjp_moved", "symbols": ["advp?", "vbn_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("vbn_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg", "not?", "adjunct_list_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_adjp", "not?", "adjunct_list_adjp_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_to_inf_cl", "not?", "adjunct_list_to_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_bare_inf_cl", "not?", "adjunct_list_bare_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_that_declarative_cl", "not?", "adjunct_list_that_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_bare_declarative_cl", "not?", "adjunct_list_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_exclamative_cl", "not?", "adjunct_list_exclamative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_interrogative_cl", "not?", "adjunct_list_interrogative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    ...
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np", "not?", "adjunct_list_np_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_adjp", "not?", "adjunct_list_np_adjp_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_to_inf_cl", "not?", "adjunct_list_np_to_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_bare_inf_cl", "not?", "adjunct_list_np_bare_inf_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_that_declarative_cl", "not?", "adjunct_list_np_that_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_bare_declarative_cl", "not?", "adjunct_list_np_bare_declarative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_exclamative_cl", "not?", "adjunct_list_np_exclamative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_interrogative_cl", "not?", "adjunct_list_np_interrogative_cl_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    {"name": "vbg_vp_adjp_moved", "symbols": ["advp?", "vbg_np_np", "not?", "adjunct_list_np_np_adjp_moved"], "postprocess": nt("vbg_vp_adjp_moved")},
    ...
    {"name": "precore_emphatic_expression", "symbols": ["precore_emphatic_modifier_adj", "adjp"], "postprocess": nt("precore_emphatic_modifier")},
